...
import { appActionCreators, AppActions } from '@/redux/app/action-creators';
...
export const appReducer: Reducer<AppTypes.AppState, AppActions> = createReducer(initialState, builder => {
  builder
